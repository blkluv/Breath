    ...
    return new Promise(resolve => this.dispatchEvent(new CustomEvent('getTimes', {
      ...
      times => {
        this.html = /* html */`
          ...
          <div><hr><a href="https://www.tomkenyon.com" target="_blank">Tom Kenyon - Flower of Life/Tree of Life Sound Meditation</a> | <a href="https://fun.luvnft.com" target="_blank">LUV NFT FUN Social</a></div>
